...
action :create do
  ...
  template_variables = {}
  %w{listen backlog preload_app worker_processes worker_class worker_connections worker_timeout worker_keepalive worker_max_requests server_hooks pid}.each do |a|
